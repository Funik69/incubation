    ...
    <div className='coform'>
      <form onSubmit={handleSubmit}>
        <div className='coadminform'>
          ...
          <label className='emaillab'>Startups applications</label><br></br>
          ...
          <label className='emaillab'>Accepted startups</label><br></br>
          ...
          <label className='emaillab'>Un-registered startups</label><br></br>
          ...
          <label className='emaillab'>Startup founder profile</label><br></br>
          ...
          <label className='emaillab'>Create event</label><br></br>
          ...
          <label className='emaillab'>Make announcements</label><br></br>
          ...
          <label className='emaillab'>Mentor list</label><br></br>
          ...
          <label className='emaillab'>Investor list</label><br></br>
          ...
          <label className='emaillab'>Mentor proposal </label><br></br>
          ...
          <label className='emaillab'>Investor  proposal </label><br></br>
          ...
          <label className='emaillab'>Make co-admin</label><br></br>
